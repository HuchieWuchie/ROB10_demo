...
def pub_joint_command(plan):
    ...
    for joint_positions in plan.joint_trajectory.points:
        ...
        goal_joint_positions = np.asanyarray(joint_positions.positions)
...
def iiwa_callback(msg):
    ...
    current_joint_positions[3] = msg.position.a4
    current_joint_positions[4] = msg.position.a5
    current_joint_positions[5] = msg.position.a6
    current_joint_positions[6] = msg.position.a7
    #current.append[msg.position.a1];
    #current.append[msg.position.a2];
    #current.append[msg.position.a3];
    #current.append[msg.position.a4];
    #current.append[msg.position.a5];
    #current.append[msg.position.a6];
    #current.append[msg.position.a7];

def iiwa_wait_until_done(joint_positions):
    done = False
    while done == False:
